...
\section{Ellipsoid deformations}
...
Complicated calculations show that the surface increases like \( 4 \pi R^2 \rightarrow 4 \pi R^2 \qty(1  + (2/5) \varepsilon^2 + O(\varepsilon^3))\).

The part of the SEMF that changes looks like

\begin{equation}
    B = - c_S R^2 - c_C \frac{Z^2}{R}  \text{const}
\end{equation}
