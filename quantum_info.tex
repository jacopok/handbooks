...
\begin{equation}
    \Tr (\rho')^2 = \frac{1}{4} \qty(\id + \vec{r'} \cdot \vec{\sigma})^2
      = \frac{1}{2} \qty(\frac{1 + \abs{r'}^2 }{2} \id + \vec{r'} \cdot \vec{\sigma})
\end{equation}
...
\begin{bluebox}
  ...
  This transformation has only \((0,0,1)\) as its fixed point.
\end{bluebox}
...
\begin{equation}
 ...
 \end{pmatrix}
\rightarrow
\int   \dd{\theta}p(\theta) \begin{pmatrix}
P   & \alpha e^{-i \theta} \\
 \alpha^* e^{i \theta}  & 1-P
\end{pmatrix}
\end{equation}
...
\begin{bluebox}
  ...
  \begin{equation}
      E_0 = \sqrt{1-P} \begin{pmatrix}
      1   & 0 \\
      0   & 1
      \end{pmatrix}
      \qquad
      E_2 = \sqrt{P} \begin{pmatrix}
      0   & 0  \\
      0   & 1
      \end{pmatrix}
      \qquad
...
\begin{equation}
    \rho(t) = \mathcal S (t_0, t) \qty[\rho]
    \qquad
    \mathcal S \qty[\rho] = \sum _{k=0}  ^{N-1} E_k \rho E_k ^\dag
\end{equation}
